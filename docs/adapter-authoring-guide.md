...
profile (claude/codex/gemini/copilot/antigravity/grok) or that you've run by hand.
...
| `usage_parser`                     |          | `none`             | Which transcript token parser to use — one of `claude-jsonl`, `codex-rollout`, `gemini-chat`, `copilot-events`, `grok-updates`, `none`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| `ignore_foreign_session_end`       |          | `false`            | Set `true` for CLIs that run each subagent as its own session and fire `SessionEnd` when the _subagent_ finishes, carrying its own session id (grok). The first `SessionStart`'s id is pinned as the main session and a `SessionEnd` carrying a different id is ignored, so a finished subagent is not read as the CLI dying. A `SessionEnd` with no id, or one seen before any `SessionStart`, still ends the session. Leave `false` and every `SessionEnd` ends the session.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `transcript_template`              |          | `""`               | Where the CLI keeps a session's transcript, for CLIs whose `SessionStart` payload carries a session id and cwd but no transcript path (grok). Placeholders `{session_id}` (required) and `{cwd_url}` (the cwd percent-encoded, `/` included); a leading `~` expands. The adapter fills it in on the first hook event that names no transcript, so the mid-session token budget guard and idle tracking see it from the start rather than from the first `Stop`. Leave empty to rely on the payload.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
